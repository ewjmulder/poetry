...
def test_exporter_exports_requirements_txt_without_extra_indices(tmp_dir, poetry):
    poetry.pool.add_repository(
        LegacyRepository(
            "custom",
            "https://example.com/simple",
    ...
    exporter.export("requirements.txt", Path(tmp_dir), "requirements.txt", dev=True, with_repositories=False)
